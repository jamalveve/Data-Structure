...
public class LeetCodeFIndMiddle {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Actual: " + (myLinkedList1.findMiddleNode() == null ? "null" : myLinkedList1.findMiddleNode().value));
		System.out.println();
		...
		System.out.println("Actual Middle Node: "
				+ (myLinkedList1.findMiddleNode() == null ? "null" : myLinkedList1.findMiddleNode().value));
		System.out.println();
